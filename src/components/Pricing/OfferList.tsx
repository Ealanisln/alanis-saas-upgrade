...
const OfferList = ({
  ...
  return (
    <div className="flex items-center py-2">
      <span className="mr-3 flex h-5 w-5 items-center justify-center rounded-full bg-primary bg-opacity-10 text-primary">
        {status === "active" ? checkIcon : crossIcon}
      </span>
      <p className="text-base text-body-color dark:text-gray-300">{text}</p>
    </div>
  );
};
