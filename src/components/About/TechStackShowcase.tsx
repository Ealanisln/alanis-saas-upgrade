...
const TypeScriptIcon = () => (
  <svg viewBox="0 0 128 128" className="h-10 w-10">
    <path
      fill="#007acc"
      d="M2 63.91v62.5h125v-125H2zm100.73-5a15.56 15.56 0 017.82 4.5 20.58 20.58 0 013 4c0 .16-5.4 3.81-8.69 5.85-.12.08-.6-.44-1.13-1.23a6.55 6.55 0 00-5.77-3.14c-3.87-.23-6.35 1.67-6.34 4.92a4.72 4.72 0 00.49 2.38c.68 1.4 2 2.31 5.92 4.14 7.27 3.32 10.4 5.52 12.48 8.7a17.14 17.14 0 011.9 8.3 18.3 18.3 0 01-2 8.83c-2.91 5.06-8.39 7.69-16.1 7.78a27.26 27.26 0 01-8.38-.86 18.55 18.55 0 01-9.29-6.42c-.79-1.1-.79-1.1 5.89-5.25l5.75-3.66.94 1.37a10.64 10.64 0 006.58 4.64 10.16 10.16 0 008-1.08 4.33 4.33 0 001.34-5c-.7-1.32-2.15-2.26-6.87-4.47-5.42-2.53-7.74-4.07-9.79-6.45a16.09 16.09 0 01-2.93-7.15 26.58 26.58 0 01.3-8.85c2.32-7.44 9-12.11 18-12.43a28.86 28.86 0 019.26 1.21zM49.21 64v8h16.65v51.83h10.28V72h16.65v-7.92H49.2z"
    />
  </svg>
);
...
const PostgreSQLIcon = () => (
  <svg viewBox="0 0 128 128" className="h-10 w-10">
    <path
      d="M93.809 92.112c.785-6.533.55-7.492 5.416-6.433l1.235.108c3.742.17 8.637-.602 11.513-1.938 6.191-2.873 9.861-7.668 3.758-6.409-13.924 2.873-14.881-1.842-14.881-1.842 14.703-21.815 20.849-49.508 15.543-56.287-14.47-18.489-39.517-9.746-39.936-9.52l-.134.025c-2.751-.571-5.83-.912-9.289-.968-6.301-.104-11.082 1.652-14.535 4.41 0 0-44.19-18.2-42.153 22.94.433 8.746 12.4 66.249 26.679 48.9 5.223-6.341 10.267-11.705 10.267-11.705 2.504 1.659 5.502 2.526 8.686 2.21l.245-.022c-.076.775-.106 1.532-.084 2.39-3.237 3.617-2.289 4.251-8.77 5.585-6.561 1.349-2.706 3.75-.19 4.377 3.042.759 10.084 1.834 14.842-4.806l-.218.9c1.46 1.168 2.481 7.578 2.312 13.388-.17 5.809-.322 9.793-.19 12.929.132 3.136.552 5.595 1.878 7.369.627.839 1.383 1.547 2.246 2.141 1.152.752 2.561 1.303 4.207 1.7 2.752.663 5.856.872 9.149.822 1.535-.024 3.107-.082 4.702-.18 5.407-.333 10.64-1.074 13.523-2.236 2.47-1.053 4.188-2.434 4.888-4.237.38-.983.529-2.036.456-3.226z"
      fill="#336791"
    />
  </svg>
);
