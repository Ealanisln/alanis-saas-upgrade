...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full min-h-[100dvh] bg-gradient-to-b from-blue-50/50 to-white dark:from-gray-900 dark:to-gray-dark">
      <div className="container mx-auto px-4 h-full sm:px-6 lg:px-8">
        <div className="min-h-[calc(100dvh-5rem)] flex items-center">
                ...
                {mounted && (
                  <div className="relative w-full">
                    <Image
                      ...
                      width={600}
                      height={600}
                      className="w-full h-auto object-contain rounded-lg shadow-three transition duration-300 hover:shadow-one dark:shadow-two dark:hover:shadow-gray-dark"
                      priority
                    />
                  </div>
                )}
