    ...
    >
      ...
      <div className="mt-7 flex flex-col gap-3.5 rounded-2xl border border-line bg-card p-5 shadow-card md:mt-10 md:grid md:grid-cols-[repeat(auto-fit,minmax(300px,1fr))] md:items-start md:gap-[clamp(24px,4vw,44px)] md:p-[clamp(24px,4vw,40px)]">
        <div className="contents md:flex md:flex-col md:gap-4">
          <div className="flex flex-wrap items-center gap-2 md:gap-2.5">
            <span className="rounded-full bg-accent px-[11px] py-[5px] text-[11.5px] font-semibold uppercase tracking-[0.06em] text-white md:px-3 md:text-xs">
              {t("flagship")}
            </span>
          ...
          <h3 className="text-xl font-bold leading-[1.25] tracking-[-0.015em] md:text-[clamp(22px,2.6vw,27px)]">
            {t("p1.title")}
          </h3>
          ...
          <ImageSlot
            ...
            className="md:hidden"
          />
          <p className="text-[15px] leading-[1.65] text-ink-2 [text-wrap:pretty] md:text-base md:leading-[1.7]">
            {t("p1.desc")}
          </p>
      ...
      <div className="mt-[18px] flex flex-col gap-[18px] md:mt-5 md:grid md:grid-cols-[repeat(auto-fit,minmax(300px,1fr))] md:gap-5">
        <div className={secondaryCard}>
          ...
          <h3 className="text-lg font-bold leading-[1.3] tracking-[-0.01em] md:text-[19px]">
            {t("p2.title")}
          </h3>
          <p className="text-sm leading-[1.65] text-ink-2 [text-wrap:pretty] md:text-[14.5px]">
            {t("p2.desc")}
          </p>
