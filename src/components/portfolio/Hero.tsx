...
const Hero = async () => {
  ...
  return (
    <header className="relative bg-gradient-to-b from-[var(--bg-card)] to-[var(--bg)]">
      ...
      <div className="relative mx-auto grid max-w-[1080px] grid-cols-[repeat(auto-fit,minmax(320px,1fr))] items-center gap-[clamp(32px,5vw,56px)] px-5 pb-11 pt-12 md:px-6 md:pb-[clamp(56px,8vw,96px)] md:pt-[clamp(64px,8vw,104px)]">
        <div>
          <div className="fade-up inline-flex items-center gap-[9px] rounded-full border border-line-2 bg-card py-2 pl-3 pr-[13px] md:gap-2.5 md:pl-[13px] md:pr-[15px]">
            <span className="animate-pulse-dot size-[7px] shrink-0 rounded-full bg-[#16A34A]" />
            <span className="font-mono text-[10.5px] font-medium uppercase tracking-[0.06em] text-ink-2 md:text-[11.5px] md:tracking-[0.07em]">
              {t("badge")}
            </span>
          ...
          <h1
            className="fade-up mt-5 text-[40px] font-bold leading-[1.06] tracking-[-0.03em] text-ink md:mt-6 md:text-[clamp(38px,4.6vw,56px)] md:leading-[1.04]"
          ...
          <p
            className="fade-up mt-4 max-w-[520px] text-[15.5px] leading-[1.65] text-ink-3 [text-wrap:pretty] md:mt-[22px] md:text-[clamp(16px,1.8vw,18px)]"
          ...
          >
            <a
              href="/assets/Emmanuel-Alanis-Resume.pdf"
              download="Emmanuel-Alanis-Resume.pdf"
