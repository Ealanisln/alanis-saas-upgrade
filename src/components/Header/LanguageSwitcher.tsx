  ...
  return (
    <div className="relative group">
      <button
        ...
        disabled={isPending}
      >
        <span className="text-base">{localeConfig[locale as keyof typeof localeConfig].flag}</span>
        <span className="text-sm font-medium">{localeConfig[locale as keyof typeof localeConfig].name}</span>
        <svg
