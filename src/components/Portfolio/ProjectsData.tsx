...
const projects = [
  {
    ...
    description:
      "Una plataforma web completa para gestionar servicios de entrega, permitiendo el registro de conductores, vendedores y clientes. Ofrece entregas el mismo día, servicios bajo demanda y manejo de entregas urgentes.",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "Sistema integral de gestión para clínicas veterinarias que permite administrar perfiles de usuarios, mascotas, historiales médicos, citas, facturación y recordatorios de manera eficiente.",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "Aplicación web que permite a los usuarios generar pagarés personalizados de manera sencilla. Incluye interfaz intuitiva para ingresar información del deudor, términos de pago y detalles de los pagarés.",
    images: [
      {
